...
pub(super) fn prompt_card(
    ...
    let page = auth_page.min(LAST_PAGE);
    ...
    card.append(&widgets::wizard_progress(page, PAGE_COUNT));
    ...
    card.append(&widgets::wizard_navigation(
        page,
        PAGE_COUNT,
        authenticating,
        sender.clone(),
...
pub(super) fn initial_wizard_page() -> usize {
