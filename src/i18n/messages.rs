...
fn chinese(key: &'static str) -> &'static str {
    match key {
        ...
        "current_status" => "当前状态",
        "delete_event" => "删除日程",
        "delete_event_warning" => "这会从 Google 日历中删除该日程。",
        "deleting_event" => "正在删除日程",
        "description" => "描述",
        "edit" => "编辑",
        "edit_event" => "编辑日程",
        "end" => "结束",
        ...
        "event_deleted" => "日程已删除。",
        "event_details" => "日程详情",
        "event_not_found" => "找不到这个日程",
        "event_not_found_detail" => "它可能已经被移动、删除，或还没有重新加载。",
        "event_opened" => "Google 日历事件已打开。",
        "event_title" => "标题",
        "event_updated" => "日程已更新。",
        "events" => "个事件",
...
fn english(key: &'static str) -> &'static str {
    match key {
        ...
        "delete_event_warning" => "This will delete the event from Google Calendar.",
        ...
        "event_not_found_detail" => "It may have been moved, deleted, or not reloaded yet.",
        "event_opened" => "Google Calendar event opened.",
        "event_title" => "Title",
